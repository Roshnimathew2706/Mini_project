						...
						<section>
							<div class="inner">
								...
								<div class="form-group" id="radio">
									...
									<label>
										<input type="radio" class="type_of_laundry" name="type_of_laundry" id="SteamIroningCheck" value="Steam Iron" checked>
									</label>Weight-Based
								...
								<div class="form-row" id="SteamIroning_checked" name="SteamIroning_checked">
									<div class="form-holder form-holder-1">
										...
										<ol>
											<li>CLOTHES (Steam-Iron) 5KG = 800 OR 160/KG</li>
