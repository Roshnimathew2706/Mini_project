...
<html lang="id">
	<head>
		...
		<script src="js/order1.js"></script>
						...
						<section>
							<div class="inner">
								...
								<div class="form-group" id="radio">
									...
									<label>
										<input type="radio" class="type_of_laundry" name="type_of_laundry" id="SteamIroningCheck" value="Wash&Fold" checked>
									</label>Weight-Based
								...
								<div class="form-row" id="SteamIroning_checked" name="SteamIroning_checked">
									<div class="form-holder form-holder-1">
										...
										<ol>
											<li>CLOTHES (Wash + Fold) 5KG = 600 OR 120/KG</li>
